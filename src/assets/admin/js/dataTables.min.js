...
!(function (n) {
        ...
        ? ((a = require("jquery")),
          "undefined" == typeof window
              ? (module.exports = function (e, t) {
                    return (
                        (e = e || window), (t = t || a(e)), n(t, e, e.document)
                    );
                })
                      ...
                      if ("table" != this.nodeName.toLowerCase())
                          ...
                          for (t = 0, R = o.length; t < R; t++) {
                              ...
                              if (
                                  ...
                                  var l = (void 0 !== e.bRetrieve ? e : a)
                                          .bRetrieve,
                                      s = (void 0 !== e.bDestroy ? e : a)
                                          .bDestroy;
                          ...
                          var F,
                              ...
                              N =
                                  ...
                                  c.oFeatures);
                          if (
                              (e.bStateSave && (N.bStateSave = !0),
                              void 0 === e.aaSorting)
                          )
                              for (
                                  var j = c.aaSorting, t = 0, R = j.length;
                                  t < R;
                                  t++
                              )
                ...
                : ((f = function (e, t, n) {
                      ...
                      if ("" !== n)
                          for (var i = ge(n), l = 0, s = i.length; l < s; l++) {
                              if (
                                  ((d = i[l].match(pe)), (a = i[l].match(p)), d)
                              ) {
                                  if (
                                      ((i[l] = i[l].replace(pe, "")),
                                      "" !== i[l] && (e = e[i[l]]),
        ...
        if ("ssp" !== J(e))
            for (t = 0, n = u.length; t < n; t++) {
                ...
                var b = C.type.className[l.sType],
                    b =
                        (b && (ue(e.aoHeader, t, b), ue(e.aoFooter, t, b)),
                        C.type.render[l.sType]);
                if (b && !l._render) {
                    (l._render = V.util.get(b)), (y = w = S = x = D = void 0);
                    for (
                        var y, D = e, x = t, S = D.aoData, w = 0;
                        w < S.length;
                        w++
                    )
                        S[w].nTr &&
    ...
    function B(e, t, n, a) {
        ...
        if (r) {
            var o = e.iDraw,
                ...
                r = r._aData,
                l = i.sDefaultContent,
                s = i.fnGetData(r, a, { settings: e, row: t, col: n });
            if (
                void 0 ===
                (s =
            ...
            return null === s && "display" === a
                ? ""
                : (s =
                      "filter" === a && (t = V.ext.type.search)[i.sType]
                          ? t[i.sType](s)
                          : s);
        }
    }
    ...
    function be(e, t, n, a) {
        ...
        if (
            ...
            if (l)
                ...
                else for (r = 0, o = l.length; r < o; r++) he(l[r], s[r]);
    ...
    function ye(e, t, n, a) {
        function r(e, t) {
            ...
            "string" == typeof e &&
                -1 !== (n = e.indexOf("@")) &&
                ((n = e.substring(n + 1)), v(e)(a, t.getAttribute(n)));
        }
        function o(e) {
            (void 0 !== n && n !== d) ||
                ((l = f[d]),
        ...
        return (
            t && (t = t.getAttribute("id")) && v(e.rowId)(a, t),
            { data: a, cells: u }
        );
    }
    function De(e, t) {
            ...
            for (
                ...
                (i = e.aoColumns[l]),
                    (o = (u = !n || !a[l])
                        ...
                        : a[l]) || $(e, 0, "Incorrect column count", 18),
    ...
    function S(e, t) {
        if (
            ...
            if (0 !== o.length)
                for (
                    var d = r ? e.aoData.length : s, f = r ? 0 : i;
                    f < d;
                    f++
                ) {
                    for (
        ...
        for (var n = 0; n < o.length; n++)
            delete o[n].rowNum,
                !(function (o, i) {
                    function l(e, t) {
                        return (
                            C.features[e] || $(o, 0, "Unknown feature: " + e),
                    ...
                    function e(e) {
                        if (i[e])
                            for (
                                var t, n = i[e].contents, a = 0, r = n.length;
                                a < r;
                                a++
                            )
                                n[a] &&
    ...
    function Ie(t) {
        ...
        if (((t.nTableWrapper = r[0]), t.sDom))
            ...
            n.forEach(function (e) {
                ...
                g(t, r, { full: { table: !0, contents: [qe(t)] } }),
                e.forEach(function (e) {
                    g(t, r, e);
                });
        }
    ...
    function Oe(e, t, n, a, r) {
        if ("" !== n) {
            for (
                ...
                ((l && l(c, u._aData, e[o], r)) || (s && s.test(c))) &&
                    i.push(e[o]);
            }
    ...
    function Be(t) {
        ...
        if (t.scrollBarVis !== f && void 0 !== t.scrollBarVis)
            ...
            a.find("colgroup").remove(),
                ...
                c &&
                    (l.find("colgroup").remove(), l.append(t.colgroup.clone())),
    ...
    function ze(e, t) {
        if (!(t.length < 2)) {
            for (
                var n = e.aiDisplayMaster, a = {}, r = {}, o = 0;
                o < n.length;
                o++
            )
                a[n[o]] = o;
        ...
        function t(e) {
            ...
            H.isPlainObject(e)
                ? void 0 !== e.idx
                    ? a.push([e.idx, e.dir])
                    : e.name &&
                      -1 !== (t = m(n.aoColumns, "sName").indexOf(e.name)) &&
                      a.push([t, e.dir])
                : a.push(e);
        }
    ...
    function Ze(e) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (t = 0, n = r.length; t < n; t++)
                (a = r[t].src),
                    H(m(e.aoData, "anCells", a)).removeClass(
                        o + (t < 2 ? t + 1 : 3)
                    );
            for (t = 0, n = i.length; t < n; t++)
                (a = i[t].src),
                    H(m(e.aoData, "anCells", a)).addClass(
                        o + (t < 2 ? t + 1 : 3)
                    );
        }
        e.aLastSort = i;
    ...
    function Ke(n, e, t) {
        ...
        if (e && e.time) {
            ...
            if (0 < l && e.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
                ...
                -1 !==
                G(n, "aoStateLoadParams", "stateLoadParams", [n, e]).indexOf(!1)
            )
                n._bLoadingState = !1;
                ...
                if (
                    ...
                    void 0 !== e.search &&
                        H.extend(n.oPreviousSearch, e.search),
                    e.columns)
                ) {
    ...
    function $(e, t, n, a) {
        if (
            ...
            if ((e && G(e, null, "dt-error", [e, a, n], !0), "alert" == t))
                alert(n);
            else {
    ...
    (X = function (e, t) {
        ...
        H.extend(X.prototype, {
            ...
            iterator: function (e, t, n, a) {
                ...
                return f.length || a
                    ? (((e = (a = new X(h, e ? f.concat.apply([], f) : f))
        ...
        (X.register = t =
            function (e, t) {
                if (Array.isArray(e))
                    ...
                    for (
                        var r = e.split("."), o = ot, i = 0, l = r.length;
                        i < l;
                        i++
                    ) {
                        var s,
        ...
        if (n.length && e.length) {
            ...
            if (a._details) {
                ...
                var i = n[0],
                    ...
                    l = i.aoData;
                if (
                    (r.off(t + " " + e + " " + a), m(l, "_details").length > 0)
                ) {
                    r.on(t, function (e, t) {
                        if (i !== t) return;
                        r.rows({ page: "current" })
    ...
    var vt = function (e, t) {
        ...
        mt =
            ...
            e("rows().ids()", "row().id()", function (e) {
                for (
                    var t = [], n = this.context, a = 0, r = n.length;
                    a < r;
                    a++
                )
        ...
        xt =
                ...
                var t = this,
                    ...
                    e = this.iterator("column", function (e, t) {
                        ...
                        !(function (e, t, n) {
                            ...
                            if (n)
                                for (
                                    var s = m(o, "bVisible").indexOf(!0, t + 1),
                                        u = 0,
                                        c = l.length;
                                    u < c;
                                    u++
            ...
            e("cells().indexes()", "cell().index()", function () {
                return this.iterator(
                    "cell",
                    function (e, t, n) {
                        return { row: t, column: n, columnVisible: re(e, n) };
                    },
                    1
                );
            }),
    ...
    if (void 0 !== W.Intl)
        try {
            for (
                var At = new Intl.NumberFormat().formatToParts(100000.1), a = 0;
                a < At.length;
                a++
            )
                "group" === At[a].type
                    ? (Lt = At[a].value)
                    : "decimal" === At[a].type && (It = At[a].value);
        } catch (e) {}
                        ...
                        function (e, t) {
                            if (p === t) {
                                for (
                                    var n = v.order,
                                        a = t.api.columns(g),
                                        r = p.aoColumns[a.flatten()[0]],
                                        o = a.orderable().includes(!0),
                                        i = "",
                                        l = a.indexes(),
                                        s = a.orderable(!0).flatten(),
                                        u = t.sortDetails,
                                        c = m(u, "col"),
                                        d =
                                            (g
        ...
        return (
            t <= n
                ...
                ? e <= 1
                    ? (r = [0, 1, "ellipsis"])
                    : t - 2 <= e
                    ? (r = h(t - 2, t)).unshift("ellipsis")
                    : (r = ["ellipsis", e, "ellipsis"])
                : e <= o
                ? ((r = h(0, n - i)).push("ellipsis"), a && r.push(t - 1))
                : t - 1 - o <= e
                ? ((r = h(t - (n - i), t)).unshift("ellipsis"),
                  a && r.unshift(0))
                : ((r = h(e - o + i, e + o - l)).push("ellipsis"),
                  r.unshift("ellipsis"),
                  a && (r.push(t - 1), r.unshift(0))),
            r
        );
    }
    V.feature.register(
                    ...
                    !(function e(t, n, a) {
                        ...
                        var r = a.type ? V.ext.pager[a.type] : Ot,
                            ...
                            f = r(a)
                                .map(function (e) {
                                    return "numbers" === e
                                        ? Et(c, d, a.buttons, a.boundaryNumbers)
                                        : e;
                                })
                                .flat();
                        var h = [];
    ...
    return (
        V.feature.register(
            ...
            function (a, e) {
                ...
                return (
                    c.find("label").attr("for", "dt-length-" + kt),
